				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a class="submenu" href="{{ route('add-Brand') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Brand</span></a></li>
                                <li><a class="submenu" href="{{ route('all-Brand') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Brand</span></a></li>
                            </ul>	
                        </li>
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="{{ route('add-Subcategory') }}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Sub Category</span></a></li>
						...
						<li><a href="{{ route('manage-order') }}"><i class="icon-edit"></i><span class="hidden-tablet"> Manage Order</span></a></li>
