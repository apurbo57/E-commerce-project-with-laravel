...
<div id="hero">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		...
		<div class="item" style="background-image: url({{ asset('uploads/slider/'. $sliders->image) }});">
			<div class="container-fluid">
				<div class="caption bg-color vertical-center text-left">
					...
					<span>{{ $sliders->sub_title }}</span>

					</div>
					<div class="button-holder fadeInDown-3">
						<a href="{{ $sliders->url }}" class="btn-lg btn btn-uppercase btn-primary shop-now-button">Shop Now</a>
					</div>
				</div><!-- /.caption -->
			</div><!-- /.container-fluid -->
		</div><!-- /.item -->
...
<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="{{ route('product', $products->id) }}"><img height="250px" width="970px"  src="{{ asset('uploads/product/'. $products->image) }}" alt=""></a>
			</div><!-- /.image -->			
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="{{ route('product', $products->id) }}">{{ $products->product_name }}</a></h3>
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<a href="{{ route('product', $products->id) }}" data-toggle="tooltip" class="btn btn-primary icon"><i class="fa fa-shopping-cart"></i></a>					
						</li>
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('fontend/images/products/p5.jpg') }}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('fontend/images/products/p6.jpg') }}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('fontend/images/blank.gif') }}" data-echo="{{ asset('fontend/images/products/p7.jpg') }}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('fontend/images/products/p8.jpg') }}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('fontend/images/products/p9.jpg') }}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('fontend/images/products/p10.jpg') }}" alt=""></a>
			</div><!-- /.image -->			
